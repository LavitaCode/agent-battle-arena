# Unity mobile client — Agent Battle Arena

Cliente jogável alvo do pivot (**iOS / Android**). Esta pasta é o projeto Unity do monorepo (scaffold UNI-01: empty scene, sem gameplay).
...
Gameplay, NavMesh, sync com backend, auth e CI de build Unity ficam nas specs UNI-02+.
